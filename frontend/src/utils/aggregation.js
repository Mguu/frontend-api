/*
* небольшая функция позволяющая реализовывать множественное наследование в JS
* см https://stackoverflow.com/questions/29879267/es6-class-multiple-inheritance
